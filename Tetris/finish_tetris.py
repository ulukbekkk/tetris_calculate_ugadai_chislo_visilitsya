...
def on_closing():
    global app_running
    if messagebox.askokcancel("Не выходи я же старался по играй еще", "Братан ты реально хочешь выйти из приложения?\nНу и уходи тогда"):
        app_running = False
        #tk.destroy()
...
img_obj1 = PhotoImage(file="nastya.png")
sc.create_image(-200, 0, anchor=NW, image=img_obj1)

img_obj2 = PhotoImage(file="atai.png")
game_sc.create_image(-100, -200, anchor=NW, image=img_obj2)
...
sc.create_text(495, 400, text='Python18 the best', font=('WiGuru 2', 20), fill='black', anchor=NW)
sc.create_text(495, 440, text='made by Uluk', font=('WiGuru 2', 23), fill='gold', anchor=NW)
